def add_arguments(parser):
    ...
    '''
    parser.add_argument('-r', '--render', help='show_game', action='store_true')
    parser.add_argument('--train_ppo2', action='store_true', help='whether train ppo2')
    parser.add_argument('--test_ppo2', action='store_true', help='whether test ppo2')
    ...
    parser.add_argument('--duel', action='store_true', default=True)
